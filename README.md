...
("The Lit" research paper browser): ABS 3 journals in the remaining business fields.
...
- publishes `/data/` on this repo's GitHub Pages site — served under
  `https://www.stouras.com/lit-data-abs3-rest/data/`, the same origin as the lit
